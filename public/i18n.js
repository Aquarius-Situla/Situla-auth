...
const translations = {
    "zh": {
        ...
        "totp_subtitle_rc": "请输入 8 位应急恢复码以登录账户。",
        ...
        "fido2_subtitle_nfc": "将您的硬件安全密钥贴近设备顶部 (NFC) 或插入接口以进行验证。",
    ...
    "en": {
        ...
        "totp_subtitle_rc": "Enter an 8-character recovery code to sign in.",
        ...
        "fido2_subtitle_nfc": "Hold your security key near the top of your device (NFC) or plug it in to verify.",
